...
const MEMORIES = [
  { caption: 'That time we went absolutely unhinged', emoji: '🎉' },
  { caption: 'Looking like a main character', emoji: '🎬' },
  { caption: 'Iconic. No further comment needed.', emoji: '🎂' },
  { caption: 'The toast that changed everything 🥂', emoji: '🥂' },
  { caption: 'Genuinely glowing at all times', emoji: '✨' },
  { caption: 'Another day, another banger moment', emoji: '📸' },
];
const REASONS = [
  {
    emoji: '🌮',
    text: "Your food order is always the most chaotic thing on the menu — and it's always the best call.",
  },
  {
    emoji: '😂',
    text: "You somehow make every situation 10x funnier just by being in it. It's a gift, really.",
  },
  {
    emoji: '💌',
    text: "You're the friend who actually shows up — whether it's 3am or 3pm, rain or shine.",
  },
];
...
const MEMORY_IMAGES: (string | undefined)[] = [];
// ─────────────────────────────────────────────────────────────────────────
  ...
  return (
    <div className="min-h-screen bg-paper-50">
      ...
      <section className="px-5 pt-10 max-w-lg mx-auto">
        <h2 className="font-script text-3xl text-brass-600 text-center">Memory wall 📷</h2>
        <p className="text-center text-sm text-ink-900/60 mt-1 mb-6">
          A few reasons why you're unforgettable
        </p>
      ...
      <section className="px-5 pt-14 max-w-lg mx-auto">
        <h2 className="font-script text-3xl text-brass-600 text-center">Why we love you 🐐</h2>
        <p className="text-center text-sm text-ink-900/60 mt-1 mb-6">
          Three things that make you the GOAT
        </p>
